...
<link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Alexandria:wght@500&family=Architects+Daughter&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Comfortaa&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Mukta&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@500&display=swap" rel="stylesheet">           <!--bootstrap-->
</head>
<style>
.flex-column {
       max-width : 260px;
...
//main page not logged in navigation bar
                    ...
                    <li class="nav-item">
	                 <a class="nav-link" href="http://localhost/Restaurant-Reservation/about/index.html">About Us</a>
	             </li>
	            <li class="nav-item">
	                <a class="nav-link" href="http://localhost/Restaurant-Reservation/gallery.html">Gallery</a>
	            </li>
                    <li class="nav-item">
